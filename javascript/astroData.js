...
var signInfo = [
  {
    ...
    str: "Progressive, original, independent, humanitarian",
    wk: "Runs from emotional expression, temperamental, uncompromising, aloof"
  },
  {
    name: "Pisces",
    info:
    ...
    str: "Compassionate, artistic, intuitive, gentle, wise, musical",
    wk:
  ...
  },
  {
    ...
    wk: "Impatient, moody, short-tempered, impulsive, aggressive"
  },

  {
    ...
    str: "Reliable, patient, practical, devoted, responsible, stable",
    wk: "Stubborn, possessive, uncompromising"
  },
  {
    name: "Gemini",
    info:
    ...
    wk: "Nervous, inconsistent, indecisive"
  },
  {
    name: "Cancer",
    info:
    ...
    wk: "Moody, pessimistic, suspicious, manipulative, insecure"
  },
  {
    name: "Leo",
    info:
    ...
    image: "img/leo.jpg",
    str: "Creative, passionate, generous, warm-hearted, cheerful, humorous",
    wk: "Arrogant, stubborn, self-centered, lazy, inflexible"
  },
  {
    name: "Virgo",
    info:
    ...
    image: "img/virgo.jpg",
    str: "Loyal, analytical, kind, hardworking, practical",
    wk:
  ...
  },
  {
    ...
    image: "img/libra.jpg",
    str: "Cooperative,diplomatic, gracious, fair-minded, social",
    wk: "Indecisive, avoids confrontations, will carry a grudge, self-pity"
  },
  {
    name: "Scorpio",
    info:
    ...
    str: "Resourceful, brave, passionate, stubborn, a true friend",
    wk: "Distrusting, jealous, secretive, violent"
  },
  {
    name: "Sagittarius",
    info:
    ...
    str: "Generous, idealistic, great sense of humor",
    wk:
  ...
  },
  {
    ...
    str: "Responsible, disciplined, self-control, good managers",
    wk: "Know-it-all, unforgiving, condescending, expecting the worst"
  }
];
